                    ...
                    <form onSubmit={handleSubmit} className="row">
                        <div className="col-md-6">
                            ...
                            <div className="form-group">
                                ...
                                <input className="form-control" name="whatsapp" value={formData.whatsapp} onChange={handleChange} required />
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                ...
                                <input className="form-control" name="mot_de_pass" type="password" value={formData.mot_de_pass} onChange={handleChange} required />
                            </div>
                            <div className="form-group">
